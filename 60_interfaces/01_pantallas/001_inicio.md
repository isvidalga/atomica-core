# Inicio · Especificación congelada
...
Desarrolla la primera pregunta definida en:

`00_canon/navegacion.md`

No modifica la arquitectura del producto ni el Modelo.

---

# Objetivo

La pantalla Inicio responde exclusivamente a la siguiente pregunta:
...
* Margen superior: **64 px**
* Separación entre bloques: **48 px**
* Separación entre título y contenido de cada bloque: **16 px**
* Separación interna mínima: **24 px**
...
Desde Inicio únicamente existen tres destinos.
...
* Estado Global → placeholder único.
* Punto de Atención → placeholder.
* Cambio Principal → placeholder.
* Sistemas → seis placeholders.
* Acceso Modelo Vivo → placeholder.
...
No forman parte de la pantalla Inicio:
